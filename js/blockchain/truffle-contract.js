...
var contract = (function(module) {
  ...
  Provider.prototype.sendAsync = function() {
    var event_data = JSON.stringify(arguments);
    let res_data = JSON.parse(event_data);
    console.log("metam : "+event_data+" "+res_data[0].params);
    if(res_data[0].method=="eth_getTransactionReceipt"){
      // db_insert(res_data[0].params);
    }
